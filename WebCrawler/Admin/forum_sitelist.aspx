<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forum_sitelist.aspx.cs" Inherits="WebCrawler.Admin.forum_sitelist" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InsertSiteList(sitename, platename, siteurl, siteRank) {
            admin_forum_sitelist.InsertSiteList(sitename, platename, siteurl, siteRank, function (b) {
                var isPass = b.value;
                if (isPass) {
                    //将 文本清空
                    $("#txt_siteName").val("");
        ...
        function UpdateSiteListBySiteId(siteId, sitename, platename, siteurl, siteRank) {
            admin_forum_sitelist.UpdateSiteListBySiteId(siteId, sitename, platename, siteurl, siteRank, function (b) {
                var isPass = b.value;
                if (isPass) {
                    //将 文本清空
                    $("#txt_siteName").val("");
        ...
        function deleteForumSite_click() {
            ...
            admin_forum_sitelist.DeleteSiteListBySiteId(siteId, function (b) {
                var isPass = b.value;
                if (isPass) {
