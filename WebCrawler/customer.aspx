            ...
            <div class="nav">
                <ul class="nav_1">
                    ...
                    <li><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=2&a=1">正面
                        Positive</a></label></li>
                    <li style="display: none"><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=2&a=2">中性
                        Neutral</a></label></li>
                ...
                <ul class="nav_1">
                    ...
                    <li><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=1&a=1">正面
                        Positive</a></label></li>
                    <li style="display: none"><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=1&a=2">中性
                        Neutral</a></label></li>
                ...
                <ul class="nav_1">
                    ...
                    <li><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=3&a=1">正面
                        Positive</a></label></li>
                    <li style="display: none"><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=3&a=2">中性
                        Neutral</a></label></li>
                    <li><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=3&a=3">负面
                        Negative</a></label></li>
                </ul>
                <ul class="nav_1">
                    <li class="orangeImgBg" id="li_gb_4"><a href="customer.aspx?type=sitedata&c=5&a=0">微博
                        Microblog</a></li>
                    <li><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=5&a=1">正面
                        Positive</a></label></li>
                    <li style="display: none"><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=5&a=2">中性
                        Neutral</a></label></li>
                    <li><span>img</span><label class="li_txtleft"><a href="customer.aspx?type=sitedata&c=5&a=3">负面
                        Negative</a></label></li>
                </ul>
                <ul class="nav_4">
                    <li class="title"><a runat="server" id="a_contendFhref" href="customer.aspx?type=sitedata&c=2&a=1&contendId=">
                        <span style="text-indent: 15px; display: block; width: 150px; _width: 140px; background: none;
                            margin-top: 13px; color: #458eb7; font-weight: bold; text-align: center; _text-align: right;
                            margin-left: 17px; _margin-left: 5px;">竞争社 Competitor</span></a></li>
            ...
            <div class="main_title_bg">
                <div class="search">
                    ...
                    <div style="">
                        ...
                        <select class="search_Xiala" style="visibility: hidden; width: 10px;" runat="server"
                            id="file2">
                            <option value=""></option>
                        </select>
                            ...
                            <tr class="content">
                                ...
                                <td class="tx_lt">
                                    ...
                                    <a href='<%#Eval("SrcUrl") %>' target="_blank" onmouseover="javascript:show_title('null')">
                                        <%#IsSubString(DataBinder.Eval(Container.DataItem, "Title").ToString(), 30)%></a>
                                </td>
                                <td>
                                    <span>
