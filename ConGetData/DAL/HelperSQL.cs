...
namespace ConGetData.DAL
{
    ...
    public abstract class HelperSQL
    {
        ...
        public static DataTable SelectData(string sql, SqlParameter[] parms, CommandType cmdType)
        {
        ...
        public static object ExecuteScalar(string sql, SqlParameter[] parms, CommandType cmdType)
        {
            object obj = null;
